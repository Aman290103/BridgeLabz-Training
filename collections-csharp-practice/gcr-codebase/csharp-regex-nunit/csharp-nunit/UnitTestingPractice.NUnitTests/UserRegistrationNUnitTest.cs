...
namespace UnitTestingPractice.NUnitTests{
    ...
    public class UserRegistrationNUnitTest{
        ...
        public void RegisterUser_InvalidUsername_ThrowsException(){
            Assert.Throws<ArgumentException>(() =>registration.RegisterUser("", "test@mail.com", "Password123"));
        }
        [Test]
        public void RegisterUser_InvalidEmail_ThrowsException(){
            Assert.Throws<ArgumentException>(() =>registration.RegisterUser("user", "invalidEmail", "Password123"));
        }
        [Test]
        public void RegisterUser_InvalidPassword_ThrowsException(){
            Assert.Throws<ArgumentException>(() =>registration.RegisterUser("user", "test@mail.com", "123"));
        }
    }
}