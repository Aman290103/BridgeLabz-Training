...
public class UnitConverter{
      ...
      public static void Main(string[] args){
            ...
            Console.WriteLine($"{km} kilometers is {ConvertKmToMiles(km)} miles.");

            Console.WriteLine("Enter distance in miles:");
            double miles = Convert.ToDouble(Console.ReadLine());
            Console.WriteLine($"{miles} miles is {ConvertMilesToKm(miles)} kilometers.");

            Console.WriteLine("Enter distance in meters:");
            double meters = Convert.ToDouble(Console.ReadLine());
            Console.WriteLine($"{meters} meters is {ConvertMetersToFeet(meters)} feet.");

            Console.WriteLine("Enter distance in feet:");
            double feet = Convert.ToDouble(Console.ReadLine());
            Console.WriteLine($"{feet} feet is {ConvertFeetToMeters(feet)} meters.");
      }
}